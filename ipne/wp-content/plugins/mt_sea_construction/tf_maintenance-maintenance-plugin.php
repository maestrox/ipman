...
Plugin Name:  MT Construction
Plugin URI:   http://marval.com.ve/
Version:      1.1.7
Description:  Adds a maintenance-page to your site.
Author:       MT Solutions
Author URI:   http://marval.com.ve/
...
<div class="wrap" id="tfuse_fields">
  ...
  <div class="tfuse_header">
    ...
    <div class="header_text">
      <h3>
        <?php _e( "MT Construction" ); ?>
      </h3>
      <a href="http://www.marval.com.ve" target="_blank" title="Go to ThemeFuse"><img src="<?php echo $this->location_folder; ?>/images/by_mt.png" /></a>
      <div class="clear"></div>
      <div class="links"> <a target="_blank" href="http://www.marval.com.ve">Support Forums</a>&nbsp;&nbsp;<span> version 1.0.0 </span></div>
    </div>
	<!-- .header_text -->
	<div class="clear"></div>
	<a href="http://www.marval.com.ve" target="_blank" title="Go to ThemeFuse"><img style="margin-top:10px; margin-left:17px;" src="<?php echo $this->location_folder; ?>/images/banner.jpg" /></a>	
   </div>
   <!-- .tfuse_fheader -->
  <br />
	...
	<table class="form-table-tf">
      ...
      <tr valign="top">
        ...
        <td><input name="tf_maintenance_date" type="text" id="tf_maintenance_date" value="<?php echo($this->_settings['tf_maintenance_date']); ?>" class="regular-text" />
            ...
            <?php _e( 'Selecciona la fecha de brindis o apertura. ex: 03/16/2011 00:00' ); ?>
          </span> </td>
      </tr>
      <tr valign="top">
      ...
      <tr valign="top">
        ...
        <td><input name="tf_maintenance_complete_percent" type="text" id="tf_maintenance_complete_percent" value="<?php echo($this->_settings['tf_maintenance_complete_percent']); ?>" class="regular-text" />
            <span class="description">
            <?php _e( 'Ingrese el porcentaje de avance %' ); ?>
          </span> </td>
      </tr>
      <tr valign="top">
